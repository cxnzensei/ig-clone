...
export default function ModalProfilePhoto() {
	...
	const uploadPost = async () => {
		...
		const imageRef = ref(storage, `users/${docId}/profilePhoto`);
							...
							<div>
								...
								<div className="mt-5 sm:mt-6">
									<button
										...
										focus:ring-2 focus:ring-offset-2 focus:ring-red-primary sm:text-sm ${!selectedFile}:bg-black-light
